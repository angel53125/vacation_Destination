...
public class Database {
    private static ArrayList<VacationDestiation> allDestinations;


    public static ArrayList<VacationDestiation> getData()
    {
    ...
    {
        allDestinations = new ArrayList<VacationDestiation>();

        //Put in loop
        //allDestinations.add(new VacationDestiation("New Dehli",R.drawable.thumb_1_0));
